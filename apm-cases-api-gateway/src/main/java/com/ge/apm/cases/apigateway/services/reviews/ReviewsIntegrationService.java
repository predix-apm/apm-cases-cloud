package com.ge.apm.cases.apigateway.services.reviews;
    ...
    public Observable<List<Review>> reviewsFor(String mlId) {
        return new ObservableResult<List<Review>>() {
            ...
            public List<Review> invoke() {
                ...
                return restTemplate.exchange("http://apm-cases-reviews/reviews/{mlId}", HttpMethod.GET, null, responseType, mlId).getBody();
            }
        };
    }
